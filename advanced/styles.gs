...
parentParagraphStyle[DocumentApp.Attribute.FONT_SIZE] = 10;
parentParagraphStyle[DocumentApp.Attribute.FONT_FAMILY] = 'Open Sans';

var parentParagraphBoldStyle = {};
parentParagraphBoldStyle[DocumentApp.Attribute.FONT_SIZE] = 11;
parentParagraphBoldStyle[DocumentApp.Attribute.BOLD] = true;
...
fragmentParagraphStyle[DocumentApp.Attribute.FONT_SIZE] = 11;
